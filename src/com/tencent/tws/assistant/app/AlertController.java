			...
			case 1:
				...
				if (onlyBtn != null) {
					if (bRipple) {
						...
						onlyBtn.setBackgroundResource(R.color.tws_operat_view_bg);
					}
				}
				break;
			case 2:
				if (TextUtils.isEmpty(mButtonPositiveText)) {
					if (bRipple) {
						...
						mButtonNeutral.setBackgroundResource(R.color.tws_operat_view_bg);
						mButtonNegative.setBackgroundResource(R.color.tws_operat_view_bg);
					}
					...
					if (bRipple) {
						...
						mButtonPositive.setBackgroundResource(R.color.tws_operat_view_bg);
						mButtonNegative.setBackgroundResource(R.color.tws_operat_view_bg);
					}
