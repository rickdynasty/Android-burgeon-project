 ...
 * </table>
 */
public class AlertDialogSamplesBlack extends TwsActivity {
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        case DIALOG_YES_NO_MESSAGE:
            ...
            return new AlertDialog.Builder(AlertDialogSamplesBlack.this,android.app.AlertDialog.THEME_HOLO_DARK).
        ...
        case DIALOG_YES_NO_OLD_SCHOOL_MESSAGE:
            return new AlertDialog.Builder(AlertDialogSamplesBlack.this,AlertDialog.THEME_HOLO_DARK).setMessage(R.string.alert_dialog_two_buttons_old_school_msg)
        ...
        case DIALOG_YES_NO_LONG_MESSAGE:
            return new AlertDialog.Builder(AlertDialogSamplesBlack.this).setIconAttribute(android.R.attr.alertDialogIcon)
        ...
        case DIALOG_YES_NO_ULTRA_LONG_MESSAGE:
            return new AlertDialog.Builder(AlertDialogSamplesBlack.this).setIconAttribute(android.R.attr.alertDialogIcon)
                    .setTitle(R.string.alert_dialog_two_buttons_msg).setMessage(R.string.alert_dialog_two_buttons2ultra_msg)
                    .setPositiveButton(R.string.alert_dialog_ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
        ...
        case DIALOG_LIST:
            return new AlertDialog.Builder(AlertDialogSamplesBlack.this).setTitle(R.string.select_dialog)
                    .setItems(R.array.select_dialog_items, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {

                            /* User clicked so do some stuff */
                            String[] items = getResources().getStringArray(R.array.select_dialog_items);
                            new AlertDialog.Builder(AlertDialogSamplesBlack.this).setMessage("You selected: " + which + " , " + items[which]).show();
                        }
                    }).setNegativeButton(R.string.alert_dialog_cancel, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
        ...
        case DIALOG_PROGRESS:
            mProgressDialog = new ProgressDialog(AlertDialogSamplesBlack.this);
        ...
        case DIALOG_SINGLE_CHOICE:
            return new AlertDialog.Builder(AlertDialogSamplesBlack.this).setIconAttribute(android.R.attr.alertDialogIcon)
                    .setTitle(R.string.alert_dialog_single_choice).setSingleChoiceItems(R.array.select_dialog_items2, 0, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
        ...
        case DIALOG_MULTIPLE_CHOICE:
            return new AlertDialog.Builder(AlertDialogSamplesBlack.this)
                    .setIcon(R.drawable.ic_popup_reminder)
                    .setTitle(R.string.alert_dialog_multi_choice)
                    .setMultiChoiceItems(R.array.select_dialog_items3, new boolean[] { false, true, false, true, false, false, false },
        ...
        case DIALOG_MULTIPLE_CHOICE_CURSOR:
            ...
            return new AlertDialog.Builder(AlertDialogSamplesBlack.this)
                    ...
                    .setMultiChoiceItems(cursor, ContactsContract.Contacts.SEND_TO_VOICEMAIL, ContactsContract.Contacts.DISPLAY_NAME,
                            new DialogInterface.OnMultiChoiceClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton, boolean isChecked) {
                                    Toast.makeText(AlertDialogSamplesBlack.this, "Readonly Demo Only - Data will not be updated", Toast.LENGTH_SHORT).show();
                                }
                            }).create();
