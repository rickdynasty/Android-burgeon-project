package com.tencent.tws.assistant.apidemos.floatview;
...
import com.tencent.tws.assistant.apidemos.widget.TwsBaseWidget;
import com.tencent.tws.assistant.widget.FloatInterface;
import com.tencent.tws.assistant.widget.FloatInterface.OnContentClickListener;
...
public class FloatViewActivity extends TwsActivity {
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				if(msg.what == 0){
//				view.setSlideOutAnimator();
//				view.setIcon(R.drawable.ic_launcher_settings);
//				view.setTitle("新的通知哦");
//				view.setSubTitle("知道啦，谢谢");
