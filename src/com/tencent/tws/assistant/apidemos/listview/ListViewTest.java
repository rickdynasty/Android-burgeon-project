...
public class ListViewTest extends TwsActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SimpleAdapter(this, list, R.layout.listviewtestitem, new String[] {
                "title", "img"}, new int[] {R.id.item1title, R.id.item1img});
    ...
    public void onClick(View v) {
        if(v==btAdd)
        {
            ...
            map.put("img", R.drawable.ic_burgeon);
            list.add(map);
