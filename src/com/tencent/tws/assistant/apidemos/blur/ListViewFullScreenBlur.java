...
public class ListViewFullScreenBlur extends TwsActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		header1 = new Button(ListViewFullScreenBlur.this);
        header1.setText("Header1");
        header2 = new Button(ListViewFullScreenBlur.this);
        header2.setText("Header2");
        footer1 = new Button(ListViewFullScreenBlur.this);
        footer1.setText("Footer1");
        footer2 = new Button(ListViewFullScreenBlur.this);
