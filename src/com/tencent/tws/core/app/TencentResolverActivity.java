...
import com.tencent.tws.core.support.v4.view.ViewPager.OnPageChangeListener;
...
import com.tencent.tws.core.widget.AdapterView.OnItemLongClickListener;
import com.tencent.tws.core.widget.CheckBox;
import com.tencent.tws.core.widget.ListView;
import com.tencent.tws.core.widget.TwsGridView;
...
public class TencentResolverActivity extends AlertActivity {
	...
	private ComponentName getPreferredAComponentNameByIntent(Intent intent){
		Uri queryIntentUri= Uri.withAppendedPath(Uri.parse("content://" + "com.tencent.tws.core.permission"),
				"intents_table");
		...
		if(mCategoryIndex >=0){
			Uri queryPreferredUri= Uri.withAppendedPath(Uri.parse("content://" + "com.tencent.tws.core.permission"),
					"defaultapp");
