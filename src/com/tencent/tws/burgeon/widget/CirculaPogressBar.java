 ...
 * 自定义圆弧进度条
 */
public class CirculaPogressBar extends View {
	...
	public CirculaPogressBar(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		init(context);
	}

	public CirculaPogressBar(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public CirculaPogressBar(Context context) {
		this(context, null);
	}
