...
import com.rickdynasty.tws.core.drawable.TwsAnimatedStateListDrawable;
import com.rickdynasty.tws.core.drawable.TwsRippleDrawable;
import com.rickdynasty.tws.core.support.annotation.DrawableRes;
import com.rickdynasty.tws.core.support.annotation.Nullable;
import com.rickdynasty.tws.core.support.v4.widget.TintableCompoundButton;
...
public class CheckBox extends android.widget.CheckBox implements TintableCompoundButton {
    ...
    final int checkOnResId = R.drawable.btn_check_to_on_mtrl_015;
