...
import com.rickdynasty.tws.core.support.v4.view.ViewConfigurationCompat;
...
public class TabIndicator extends View implements ViewPager.OnPageChangeListener, OnTabItemCenterPosListener {
	...
	public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
		...
		Log.d("rick_Print:", "TabIndicator onPageScrolled position=" + position + " positionOffset=" + positionOffset + " positionOffsetPixels=" + positionOffsetPixels);
		if (mFades) {
	...
	public void setTabsPos(int[] positions) {
		Log.d("rick_Print:", "befor setTabsPos mTabItemCenterPosX=" + mTabItemCenterPosX);
		mTabItemCenterPosX = positions;
		Log.d("rick_Print:", "after setTabsPos mTabItemCenterPosX=" + mTabItemCenterPosX);
	}
}