...
import com.rickdynasty.tws.core.drawable.TwsRippleDrawable;
...
import com.rickdynasty.tws.core.widget.TwsGridView;
...
public class TencentResolverActivity extends AlertActivity {
	...
	public static boolean isSystemApplication(ApplicationInfo applicationInfo) {
        ...
        if(applicationInfo.packageName.contains("com.rickdynasty.tws")){
	...
	private ComponentName getPreferredAComponentNameByIntent(Intent intent){
		Uri queryIntentUri= Uri.withAppendedPath(Uri.parse("content://" + "com.rickdynasty.tws.core.permission"),
				"intents_table");
		...
		if(mCategoryIndex >=0){
			Uri queryPreferredUri= Uri.withAppendedPath(Uri.parse("content://" + "com.rickdynasty.tws.core.permission"),
					"defaultapp");
