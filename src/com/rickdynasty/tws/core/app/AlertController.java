...
package com.rickdynasty.tws.core.app;
...
import com.rickdynasty.tws.core.app.AlertDialog.ButtonColor;
import com.rickdynasty.tws.core.utils.ThemeUtils;
import com.rickdynasty.tws.core.utils.TwsRippleUtils;
import com.rickdynasty.tws.core.widget.AdapterView;
import com.rickdynasty.tws.core.widget.AdapterView.OnItemClickListener;
import com.rickdynasty.tws.core.widget.CheckedTextView;
import com.rickdynasty.tws.core.widget.ListView;
import com.rickdynasty.tws.core.widget.TwsScrollView;
...
public class AlertController {
		...
		if (!mButtonBGSet) {
				...
				if (onlyBtn != null) {
					...
					if (bRipple) {
						if (android.os.Build.VERSION.SDK_INT > 15) {
							onlyBtn.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_full));
						} else {
							onlyBtn.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_full));
						}
					} else {
						onlyBtn.setBackgroundResource(R.drawable.second_btn_dialog_full);
					}
			...
			case 2:
				if (TextUtils.isEmpty(mButtonPositiveText)) {
					...
					if (bRipple) {
						if (android.os.Build.VERSION.SDK_INT > 15) {
							mButtonNeutral.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_full));
							mButtonNegative.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_full));
						} else {
							mButtonNeutral.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_full));
							mButtonNegative.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_full));
						}
					} else {
						mButtonNeutral.setBackgroundResource(R.drawable.second_btn_dialog_right);
						mButtonNegative.setBackgroundResource(R.drawable.second_btn_dialog_left);
					...
					if (bRipple) {
						if (android.os.Build.VERSION.SDK_INT > 15) {
							mButtonPositive.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_right));
							mButtonNegative.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_left));
						} else {
							mButtonPositive.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_right));
							mButtonNegative.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_left));
						}
					} else {
						mButtonPositive.setBackgroundResource(R.drawable.second_btn_dialog_right);
						mButtonNegative.setBackgroundResource(R.drawable.second_btn_dialog_left);
					...
					if (bRipple) {
						if (android.os.Build.VERSION.SDK_INT > 15) {
							mButtonPositive.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_right));
							mButtonNeutral.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_left));
						} else {
							mButtonPositive.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_right));
							mButtonNeutral.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_left));
						}
					} else {
						mButtonPositive.setBackgroundResource(R.drawable.second_btn_dialog_right);
						mButtonNeutral.setBackgroundResource(R.drawable.second_btn_dialog_left);
			...
			case 3:
				...
				if (bRipple) {
					if (android.os.Build.VERSION.SDK_INT > 15) {
						mButtonPositive.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_right));
						mButtonNeutral.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_middle));
						mButtonNegative.setBackground(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_left));
					} else {
						mButtonPositive.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_right));
						mButtonNeutral.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_middle));
						mButtonNegative.setBackgroundDrawable(TwsRippleUtils.getHasContentDrawable(mContext, R.drawable.second_btn_dialog_left));
					}
				} else {
					mButtonPositive.setBackgroundResource(R.drawable.second_btn_dialog_right);
	...
	private boolean setupBottomButtons(LinearLayout bottomButtonsPanel) {
		...
		if (mBottomButtonsListView != null) {
			...
			bottomButtonsPanel.addView(mBottomButtonsListView, new LinearLayout.LayoutParams(MATCH_PARENT, MATCH_PARENT));
	...
	private void setBackground(LinearLayout topPanel, LinearLayout contentPanel, View customPanel, boolean hasButtons, TypedArray a, boolean hasTitle, View buttonPanel,
			LinearLayout bottomButtonsPanel, boolean hasBottomButtons) {

		/* Get all the different background required */
		// tws-start::added for tws theme::20121002
		int fullDark = a.getResourceId(com.android.internal.R.styleable.AlertDialog_fullDark, R.drawable.dialog_full_holo_dark);
		int topDark = a.getResourceId(com.android.internal.R.styleable.AlertDialog_topDark, R.drawable.dialog_top_holo_dark);
		int centerDark = a.getResourceId(com.android.internal.R.styleable.AlertDialog_centerDark, R.drawable.dialog_middle_holo_dark);
		int bottomDark = a.getResourceId(com.android.internal.R.styleable.AlertDialog_bottomDark, R.drawable.dialog_bottom_holo_dark);
		int fullBright = a.getResourceId(com.android.internal.R.styleable.AlertDialog_fullBright, R.drawable.dialog_full_holo_light);
		int topBright = a.getResourceId(com.android.internal.R.styleable.AlertDialog_topBright, R.drawable.dialog_top_holo_light);
		int centerBright = a.getResourceId(com.android.internal.R.styleable.AlertDialog_centerBright, R.drawable.dialog_middle_holo_light);
		int bottomBright = a.getResourceId(com.android.internal.R.styleable.AlertDialog_bottomBright, R.drawable.dialog_bottom_holo_light);
		int bottomMedium = a.getResourceId(com.android.internal.R.styleable.AlertDialog_bottomMedium, R.drawable.dialog_middle_holo_light);
	...
	public static class AlertParams {
		...
		private void createListView(final AlertController dialog) {
			...
			final boolean hasTitle = ((mCustomTitleView != null) || (mTitle != null && !TextUtils.isEmpty(mTitle)) || (mIcon != null) || (mIconId > 0)
					|| (mMessage != null && !TextUtils.isEmpty(mMessage)) || mView != null);
			final boolean hasButton = ((mPositiveButtonText != null && !TextUtils.isEmpty(mPositiveButtonText)) || (mNegativeButtonText != null && !TextUtils.isEmpty(mNegativeButtonText)) || (mNeutralButtonText != null && !TextUtils
		...
		private void createBottomButtons(final AlertController dialog) {
			...
			if (mIsBottomButtonMultiChoice) {
				...
				if (mBottomButtonCursor == null) {
					adapter = (mBottomButtonAdapter != null) ? mBottomButtonAdapter : new ArrayAdapter<CharSequence>(mContext, layout, R.id.text1, mBottomButtonItems) {
						// tws-start ListAlertDialog::2014-7-23
						final List<CharSequence> mList = Arrays.asList(mBottomButtonItems);
					...
					adapter = new SimpleCursorAdapter(mContext, layout, mBottomButtonCursor, new String[] { mBottomButtonLabelColumn }, new int[] { R.id.text1 }) {
						// tws-start ListAlertDialog::2014-7-23
						@Override
						public View getView(int position, View convertView, ViewGroup parent) {
							View view = super.getView(position, convertView, parent);
