...
public class SimpleListView extends TwsListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getListView().setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				// 用法2
				Toast.makeText(SimpleListView.this, "data = " + parent.getAdapter().getItem(position), Toast.LENGTH_LONG).show();
				// 用法3
	...
	private class SimpleItemAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null) {  
                holder = new Holder();  
                convertView = (LinearLayout) LayoutInflater.from(SimpleListView.this).inflate(R.layout.tws_listview_item_example, null);
