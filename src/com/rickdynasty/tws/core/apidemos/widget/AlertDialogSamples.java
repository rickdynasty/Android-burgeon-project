...
import com.rickdynasty.tws.core.app.CheckBoxDialog;
import com.rickdynasty.tws.core.app.EditTextDialog;
import com.rickdynasty.tws.core.app.ProgressDialog;
...
public class AlertDialogSamples extends TwsActivity {
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View convertView, ViewGroup arg2) {
			...
			if (null == convertView) {
				holder = new Holder();
				convertView = (LinearLayout) LayoutInflater.from(AlertDialogSamples.this).inflate(R.layout.item_listview, null);
	...
	protected TwsDialog onCreateTwsDialog(int id) {
		...
		case DIALOG_BOTTOM_MULT:
			qdialog = new AlertDialog.Builder(AlertDialogSamples.this, true).setMessage("bottom content msg")
					.setBottomButtonMultiChoiceItems(R.array.select_dialog_items, new boolean[] { false, true, false, true, false, false, false }, new DialogInterface.OnMultiChoiceClickListener() {
		...
		case DIALOG_BOTTOM_SINGLE:
			qdialog = new AlertDialog.Builder(AlertDialogSamples.this, true, R.style.Dialog_Bottom_Theme).setBottomButtonSingleChoiceItems(R.array.select_dialog_items2, 0,
			...
			return qdialog;
		case DIALOG_BOTTOM:
			int colors[] = { AlertDialog.BOTTOM_BUTTON_COLOR_BLACK, AlertDialog.BOTTOM_BUTTON_COLOR_BLUE, AlertDialog.BOTTOM_BUTTON_COLOR_RED, AlertDialog.BOTTOM_BUTTON_COLOR_BLUE };

			qdialog = new AlertDialog.Builder(AlertDialogSamples.this, true).setTitle("bottom dialog titles").setBottomButtonItems(R.array.select_dialog_items, new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					/* User clicked so do some stuff */
					String[] items = getResources().getStringArray(R.array.select_dialog_items);
					new AlertDialog.Builder(AlertDialogSamples.this).setMessage("You selected: " + which + " , " + items[which]).show();
				}
			}).setBottomButtonColorItems(colors).create(true);
			qdialog.setTitleTextColor(Color.RED);
			return qdialog;
		case DIALOG_NOT_DISMISS:
			qdialog = new AlertDialog.Builder(AlertDialogSamples.this).setPositiveButton("强制取消", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int whichButton) {
		...
		case DIALOG_YES_NO_MESSAGE:
			ListView lv = (ListView) LayoutInflater.from(getApplicationContext()).inflate(R.layout.listview, null, false);
			dataList = getResources().getStringArray(R.array.date);
			lv.setAdapter(new MyAdapter());
			return new AlertDialog.Builder(AlertDialogSamples.this).setView(lv).setPositiveButton(R.string.alert_dialog_two_buttons_ok, new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int whichButton) {
				}
		...
		case DIALOG_YES_NO_OLD_SCHOOL_MESSAGE:
			return new AlertDialog.Builder(AlertDialogSamples.this).setMessage(R.string.alert_dialog_two_buttons_old_school_msg)
		...
		case DIALOG_YES_NO_HOLO_LIGHT_MESSAGE:
			...
			cbd.setButton(getString(R.string.alert_dialog_two_buttons_holo_light_ok), new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
				}
			});
			cbd.setButton2(getString(R.string.alert_dialog_two_buttons_holo_light_cancel), new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
				}
			});
		...
		case DIALOG_YES_NO_LONG_MESSAGE:
			return new AlertDialog.Builder(AlertDialogSamples.this).setIconAttribute(android.R.attr.alertDialogIcon).setTitle(R.string.alert_dialog_two_buttons_msg)
		...
		case DIALOG_YES_NO_ULTRA_LONG_MESSAGE:
			return new AlertDialog.Builder(AlertDialogSamples.this).setIconAttribute(android.R.attr.alertDialogIcon).setTitle(R.string.alert_dialog_two_buttons_msg)
					.setMessage(R.string.alert_dialog_two_buttons2ultra_msg).setPositiveButton(R.string.alert_dialog_ok, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int whichButton) {
		...
		case DIALOG_LIST:
			return new AlertDialog.Builder(AlertDialogSamples.this).setTitle(R.string.select_dialog).setItems(R.array.select_dialog_items, new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
		...
		case DIALOG_SINGLE_CHOICE:
			return new AlertDialog.Builder(AlertDialogSamples.this).setIconAttribute(android.R.attr.alertDialogIcon).setTitle(R.string.alert_dialog_single_choice)
		...
		case DIALOG_MULTIPLE_CHOICE:
			return new AlertDialog.Builder(AlertDialogSamples.this).setIcon(R.drawable.ic_popup_reminder).setTitle(R.string.alert_dialog_multi_choice)
		...
		case DIALOG_MULTIPLE_CHOICE_CURSOR:
			String[] projection = new String[] { ContactsContract.Contacts._ID, ContactsContract.Contacts.DISPLAY_NAME, ContactsContract.Contacts.SEND_TO_VOICEMAIL };
			Cursor cursor = managedQuery(ContactsContract.Contacts.CONTENT_URI, projection, null, null, null);
			return new AlertDialog.Builder(AlertDialogSamples.this).setIcon(R.drawable.ic_popup_reminder).setTitle(R.string.alert_dialog_multi_choice_cursor)
					.setMultiChoiceItems(cursor, ContactsContract.Contacts.SEND_TO_VOICEMAIL, ContactsContract.Contacts.DISPLAY_NAME, new DialogInterface.OnMultiChoiceClickListener() {
						public void onClick(DialogInterface dialog, int whichButton, boolean isChecked) {
