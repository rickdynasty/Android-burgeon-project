...
package com.rickdynasty.tws.core.internal.widget;
...
import com.rickdynasty.tws.core.internal.view.menu.ActionMenuItem;
import com.rickdynasty.tws.core.internal.view.menu.ActionMenuPresenter;
import com.rickdynasty.tws.core.internal.view.menu.ActionMenuView;
import com.rickdynasty.tws.core.internal.view.menu.MenuBuilder;
import com.rickdynasty.tws.core.internal.view.menu.MenuItemImpl;
...
import com.rickdynasty.tws.core.internal.view.menu.SubMenuBuilder;
...
public class ActionBarView extends AbsActionBarView {
    ...
    private void initHome(Context context) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int) context.getResources()
                .getDimension(R.dimen.action_bar_back_btn_width), LayoutParams.MATCH_PARENT);
        ...
        if (bRipple) {
        	if (android.os.Build.VERSION.SDK_INT > 15) {
        		mHomeLayout.setBackground(TwsRippleUtils.getDefaultDarkDrawable(getContext()));
        	}
        	else {
        		mHomeLayout.setBackgroundDrawable(TwsRippleUtils.getDefaultDarkDrawable(getContext()));
        	}
        } else {
            mHomeLayout.setBackgroundResource(mHomeBGStyleRes);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (showTitle) {
			...
			if (mMenuView != null) {
				...
				tagWidth = (contentWidth / 2 - ((mHomeLayout != null && mHomeLayout.getVisibility() != View.GONE) ? mHomeLayout.getMeasuredWidth() : 0) - paddingLeft - paddingRight) * 2;
			}
