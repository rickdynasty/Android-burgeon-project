...
public class CircularProgressButton extends Button {
	...
	private void initAttributes(Context context, AttributeSet attributeSet) {
		...
		try {
			...
			mProgressText = attr.getString(R.styleable.CircularProgressButton_textProgress);
			...
			int white = getColor(R.color.tws_white);
			int grey = getColor(R.color.grey);

			int idleStateSelector = attr.getResourceId(R.styleable.CircularProgressButton_selectorIdle, R.color.idle_state_selector);
			mIdleColorState = getResources().getColorStateList(idleStateSelector);

			int completeStateSelector = attr.getResourceId(R.styleable.CircularProgressButton_selectorComplete, R.color.complete_state_selector);
			mCompleteColorState = getResources().getColorStateList(completeStateSelector);

			int errorStateSelector = attr.getResourceId(R.styleable.CircularProgressButton_selectorError, R.color.error_state_selector);
