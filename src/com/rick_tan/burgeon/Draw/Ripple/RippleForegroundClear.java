package com.rick_tan.burgeon.Draw.Ripple;
...
class RippleForegroundClear extends RippleForeground {
    ...
    public RippleForegroundClear(RippleDrawable owner, Rect bounds, float startingX, float startingY,
                                 boolean isBounded) {
...
//        final int duration = 100;
    ...
    */
     ...
     */
    private static final FloatProperty<RippleForegroundClear> TWEEN_RADIUS_ENTER = new FloatProperty<RippleForegroundClear>(
            "tweenRadiusEnter") {
        @Override
        public void setValue(RippleForegroundClear object, float value) {
            object.mTweenRadius_enter = value;
            object.invalidateSelf();
        }

        @Override
        public Float get(RippleForegroundClear object) {
     ...
     */
    private static final FloatProperty<RippleForegroundClear> TWEEN_ORIGIN_ENTER = new FloatProperty<RippleForegroundClear>(
            "tweenOriginEnter") {
        @Override
        public void setValue(RippleForegroundClear object, float value) {
     ...
     * Property for animating radius between its initial and target values.
     */
    private static final FloatProperty<RippleForegroundClear> TWEEN_RADIUS_EXIT = new FloatProperty<RippleForegroundClear>(
            "tweenRadiusExit") {
        @Override
        public void setValue(RippleForegroundClear object, float value) {
     ...
     * Property for animating origin between its initial and target values.
     */
    private static final FloatProperty<RippleForegroundClear> TWEEN_ORIGIN_EXIT = new FloatProperty<RippleForegroundClear>(
            "tweenOriginExit") {
        @Override
        public void setValue(RippleForegroundClear object, float value) {
    ...
    private static final FloatProperty<RippleForegroundClear> OPACITY = new FloatProperty<RippleForegroundClear>("opacity") {
        @Override
        public void setValue(RippleForegroundClear object, float value) {
    ...
    protected int getRippleStyle() {
        return RippleDrawable.RIPPLE_STYLE_CLEAR;
    }
}
