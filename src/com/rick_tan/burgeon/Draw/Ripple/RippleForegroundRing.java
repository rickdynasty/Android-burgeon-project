...
class RippleForegroundRing extends RippleForeground {
    ...
    public RippleForegroundRing(RippleDrawable owner, Rect bounds, float startingX, float startingY,
                                boolean isBounded) {
...
//        int duration = (int) (1000 * Math.sqrt(mTargetRadius / WAVE_TOUCH_DOWN_ACCELERATION * mDensity) + 0.5);
     ...
     */
    private static final FloatProperty<RippleForegroundRing> TWEEN_RADIUS_ENTER = new FloatProperty<RippleForegroundRing>(
            "tweenRadiusEnter") {
        @Override
        public void setValue(RippleForegroundRing object, float value) {
            object.mTweenRadius = value;
            object.invalidateSelf();
        }

        @Override
        public Float get(RippleForegroundRing object) {
     ...
     */
    private static final FloatProperty<RippleForegroundRing> TWEEN_ORIGIN_ENTER = new FloatProperty<RippleForegroundRing>(
            "tweenOriginEnter") {
        @Override
        public void setValue(RippleForegroundRing object, float value) {
    ...
    protected int getRippleStyle() {
        return RippleDrawable.RIPPLE_STYLE_RING;
    }
