...
public class RippleDrawable extends LayerDrawable {
    ...
    public RippleDrawable(ColorStateList color, Drawable content, Drawable mask, int rippleStyle) {
        this(new RippleState(null, null, null), null);
     ...
     */
    public void tryRippleEnter(boolean focused) {
        ...
        if (mRipple == null) {
            ...
            if (mRippleStyle == RIPPLE_STYLE_NORMAL) {
                ...
                mRipple = new RippleForegroundClear(this, mHotspotBounds, x, y, isBounded);
            } else if (mRippleStyle == RIPPLE_STYLE_RING) {
                mRipple = new RippleForegroundRing(this, mHotspotBounds, x, y, isBounded);
            }
        }
    ...
    public void qromSetHotspotBounds(int left, int top, int right, int bottom) {
    ...
    public void setHotspotBounds(Rect outRect) {
    ...
    public void draw(Canvas canvas) {
        ...
        final Rect bounds = setDirtyBounds();
...
//            mMaskColorFilter.setColor(fullAlphaColor);
    ...
    public Rect setDirtyBounds() {
        if (!isBounded()) {
            ...
            if (mRippleStyle == RIPPLE_STYLE_CLEAR || mRippleStyle == RIPPLE_STYLE_RING) {
                final RippleForeground ripple = mRipple;
                if (ripple != null) {
    ...
    void removeRipple(RippleForeground ripple) {
